...
export default function App() {
  ...
  const renderScreen = () => {
    ...
    switch (activeTab) {
      case "discover":
        return <DiscoverScreen makers={makers} makersLoading={makersLoading} makersError={makersError} onRetry={refetch} onRefresh={refetch} onMakerTap={handleMakerTap} savedIds={savedIds} onToggleSave={handleToggleSave} onScrollToTop={handleScrollToTop} scrollContainerRef={containerRef} locationLabel={locationLabel} locationSource={locationSource} userLocation={userLocation} setLocation={setLocation} sponsoredPosts={sponsoredPosts} />
      case "map":
        return <Suspense fallback={<ScreenPlaceholder theme={theme} />}><MapScreen makers={makers} makersLoading={makersLoading} onMakerTap={handleMakerTap} savedIds={savedIds} onToggleSave={handleToggleSave} userLocation={userLocation} /></Suspense>
      case "saved":
        return <Suspense fallback={<ScreenPlaceholder theme={theme} />}><SavedScreen makers={makers} makersLoading={makersLoading} onMakerTap={handleMakerTap} savedIds={savedIds} onToggleSave={handleToggleSave} onTabChange={handleTabChange} /></Suspense>
      case "profile":
        return <Suspense fallback={<ScreenPlaceholder theme={theme} />}><ProfileScreen /></Suspense>
      default:
        return null
    }
  }
  ...
  if (!onboardingComplete) {
    return <Suspense fallback={<ScreenPlaceholder theme={theme} />}><OnboardingScreen onComplete={completeOnboarding} setLocation={setLocation} /></Suspense>
  }
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div
          onClick={() => { setAuthToast(false); handleTabChange("profile") }}
          style={{
