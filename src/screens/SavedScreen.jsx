...
export default function SavedScreen({ makers = [], makersLoading, onMakerTap, savedIds, onToggleSave, onTabChange }) {
    ...
    <div style={{ paddingBottom: 100 }}>
      ...
      {makersLoading ? (
        <div style={{ padding: "60px 40px", textAlign: "center" }}>
          <div style={{ fontSize: 40, marginBottom: 16, opacity: 0.3, animation: "pulse 1.5s ease infinite" }}>{"\u2661"}</div>
        </div>
      ) : !user ? (
        <div style={{ padding: "60px 40px", textAlign: "center" }}>
