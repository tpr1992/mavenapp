...
import { isOpenNow, DAYS } from "../utils/time"
  ...
  return (
    <div style={{ paddingBottom: 100, animation: "fadeSlideIn 0.25s ease" }}>
      ...
      <div style={{ padding: "24px 20px" }}>
        ...
        >
          {[
            { label: "Distance", value: maker.distance != null ? formatDistance(maker.distance) : maker.city },
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      color: !hours || hours === "closed" ? theme.textMuted : isToday ? theme.text : theme.textSecondary,
                    }}
                  >
        ...
        {/* CTA */}
        <button
          onClick={() => window.open(`https://maps.apple.com/?daddr=${maker.lat},${maker.lng}`, "_blank", "noopener,noreferrer")}
          style={{
            width: "100%",
            padding: "16px 24px",
            borderRadius: 14,
