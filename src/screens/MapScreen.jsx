  ...
  return (
    <div style={{ height: "100%", position: "relative" }}>
      <Helmet>
        ...
        <meta name="description" content="Find local makers near you on the map. Explore craftspeople in Galway, Ireland." />
      </Helmet>
              ...
              {townSuggestions.map((town, i) => (
                <div
                  ...
                  style={{
                    padding: "11px 16px",
                    cursor: "pointer",
                    borderBottom: i < townSuggestions.length - 1 ? `1px solid ${theme.border}` : "none",
                    display: "flex",
                    alignItems: "baseline",
                    gap: 8,
                  }}
        ...
        >
          <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                {selectedMaker.category} {"\u00B7"} {selectedMaker.distance != null ? `${selectedMaker.distance} km` : selectedMaker.city} {"\u00B7"}{" "}
