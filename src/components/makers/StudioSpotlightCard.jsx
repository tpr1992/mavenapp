    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <div style={{ fontSize: 40, opacity: 0.5, zIndex: 1 }}>{CATEGORY_EMOJI[maker.category]}</div>
            ...
            <div style={{ padding: "16px 18px 18px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
                    ...
                    {maker.is_verified && <span style={{ fontSize: 11, color: theme.textSecondary }}>&#10003;</span>}
                </div>
                ...
                >
                    {maker.category} &middot; {formatLocation(maker)}
                </div>
